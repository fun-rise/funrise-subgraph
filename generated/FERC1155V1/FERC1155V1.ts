...
export class FERC1155V1__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class FERC1155V1 extends ethereum.SmartContract {
  static bind(address: Address): FERC1155V1 {
    return new FERC1155V1("FERC1155V1", address);
  }
  ...
  isPermanentURI(param0: BigInt): boolean {
    let result = super.call(
      "isPermanentURI",
  ...
  try_isPermanentURI(param0: BigInt): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "isPermanentURI",
      "isPermanentURI(uint256):(bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  royaltyInfo(tokenId: BigInt, value: BigInt): FERC1155V1__royaltyInfoResult {
    let result = super.call(
      "royaltyInfo",
    ...
    return new FERC1155V1__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royaltyInfo(
    tokenId: BigInt,
    value: BigInt
  ): ethereum.CallResult<FERC1155V1__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new FERC1155V1__royaltyInfoResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
...
export class MintCallOrderStruct extends ethereum.Tuple {
  ...
  get royalty(): MintCallOrderRoyaltyStruct {
    return changetype<MintCallOrderRoyaltyStruct>(this[5].toTuple());
  }
}
...
export class MintBatchCallOrderStruct extends ethereum.Tuple {
  ...
  get royalty(): MintBatchCallOrderRoyaltyStruct {
    return changetype<MintBatchCallOrderRoyaltyStruct>(this[5].toTuple());
  }
}
